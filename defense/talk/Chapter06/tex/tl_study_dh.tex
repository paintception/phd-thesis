...
\addplot [ultra thick, black, mark=x] table [x expr=\coordindex, y=baseline]{./Chapter06/logs/type_classification.txt};
\addplot [ultra thick, blue, mark=x] table [x expr=\coordindex, y=winning_ticket]{./Chapter06/logs/type_classification.txt};
\addplot [ultra thick, orange, mark=x] table [x expr=\coordindex, y=random_mask]{./Chapter06/logs/type_classification.txt};
\addplot [ultra thick, green, mark=x] table [x expr=\coordindex, y=cifar10]{./Chapter06/logs/type_classification.txt};
\addplot [ultra thick, red, mark=x] table [x expr=\coordindex, y=cifar100]{./Chapter06/logs/type_classification.txt};
\addplot [ultra thick, purple, mark=x] table [x expr=\coordindex, y=fahion_mnist]{./Chapter06/logs/type_classification.txt};
