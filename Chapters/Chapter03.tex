...
\iffalse
\begin{itemize}
	\item among the first applications \citet{van2015off} for pulmonary diseases + lots of further applications \citet{nguyen2017iris} (iris recognition), \citet{sharma2015adapting} word spotting, 
	\item \citet{wang2014action} human action understanding + combination of older CV feature engineering approaches, similar idea used by \citet{zhong2016face} face localization techniques + off 
	\item \citet{zhou2014learning} larger new dataset specifically designed for scene recognition which works better than ImageNet features. 
	\item \citet{van2015deep} gender classification 
	\item \citet{hernandez2018periocular} periocular recognition
\end{itemize}


# Jasper's paper, not limited to vision ---> mention NLP, BERT, ...
\fi
