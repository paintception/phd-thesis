...
When it comes to sequential decision making, we are interested in maximizing the value of each state or of each state-action pair, since by doing so we will be finding an optimal policy $\pi^{*}$ that realizes the optimal expected return defined as:
\begin{align}
