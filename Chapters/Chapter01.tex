...
\begin{equation}
	\lim_{M \to \infty} f^{*}_{\mathcal{L}_\text{Train}} = f^{*}.
\end{equation}
...
\end{figure}
During the traversal, also known as the \textcolor{RoyalBlue}{forward pass}, the result of each mathematical operation is stored within its own output variable, denoted $\vec{u}_i$ (see Fig. \ref{fig:computational_graph_2}). 
\begin{figure}[ht!]
	\centering
...
\paragraph{\textbf{\uppercase{I}mage \uppercase{C}lassification \uppercase{N}etworks}}
