...
\part{Machine Learning Preliminaries}
...
\part{Transfer Learning in Supervised Learning} % First part of the thesis

%\include{Chapters/Chapter01} % Introduction + Transfer Learning
...
\part{Transfer Learning in Reinforcement Learning} % Second part of the thesis
