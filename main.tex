...
%\include{Chapters/Chapter01} % Supervised Learning + Deep Learning
\include{Chapters/Chapter06} % Reinforcement Learning + Deep Learning
%\include{Chapters/Chapter01} % Transfer Learning

\cleardoublepage % Empty page before the start of the next part


\part{Transfer Learning for Supervised Learning} % First part of the thesis

\include{Chapters/Chapter03} % ECCV paper
%\include{Chapters/Chapter04} % DH Journal paper
\include{Chapters/Chapter05} % ICCVTA paper
...
\part{Transfer Learning for Reinforcement Learning} % Second part of the thesis

\include{Chapters/Chapter07} % NeurIPS DRLW + IJCNN paper
\include{Chapters/Chapter08} % ICML (under review) paper?
\include{Chapters/Chapter09} % Upside-Down RL + critical discussion
