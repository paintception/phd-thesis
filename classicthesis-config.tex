...
\newcommand{\myTitle}{Contributions to Transfer Learning: from Supervised to Deep Reinforcement Learning \xspace}
...
\usetikzlibrary{pgfplots.groupplots,positioning,angles,quotes}
\usepackage{tikz}
